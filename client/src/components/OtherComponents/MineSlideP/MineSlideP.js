...
import classes from "./MineSlideP.module.css";

export const MineSlideP = () => {
  return (
    <section className={classes.main_slide}>
      <div className={classes.container}>
        ...
        <p>
          ...
          данных и меры по обеспечению безопасности персональных данных Севриса
          сокращения ссылок "Musii.li" (далее – Оператор).
        </p>
        <p>
        ...
        <p>
          ...
          Оператор может получить о посетителях веб-сайта http://musii.li.
        </p>
        ...
        <p>
          ...
          сети интернет по сетевому адресу http://musii.li;
        </p>
        <p>
        ...
        <p>9)Пользователь – любой посетитель веб-сайта http://musii.li;</p>
        <p>
        ...
        <p>1)Электронный адрес;</p>
        <p>
          2)Также на сайте происходит сбор и обработка обезличенных данных о
          посетителях (в т.ч. файлов «cookie») с помощью сервисов
          интернет-статистики (Яндекс Метрика и Гугл Аналитика и других).
        </p>
        <p>
          3)Вышеперечисленные данные далее по тексту Политики объединены общим
        ...
        <p>
          ...
          электронной почты musii@mail.ru с пометкой «Отказ от уведомлениях о
        ...
        <p>
          ...
          специальные формы, расположенные на сайте http://musii.li. Заполняя
        ...
        <p>
          ...
          уведомление на адрес электронной почты Оператора musii.li@mail.ru с
        ...
        <p>
          ...
          электронной почты на электронный адрес Оператора musii.li@mail.ru с
        ...
        <p>
          ...
          Оператору с помощью электронной почты musii.li@mail.ru.
        </p>
        <p>
        ...
        <p>
          ...
          Интернет по адресу http://musii.li/page/policy.
        </p>
      </div>
    </section>
  );
